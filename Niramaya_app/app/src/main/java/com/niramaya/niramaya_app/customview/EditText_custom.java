...
public class EditText_custom extends androidx.appcompat.widget.AppCompatEditText
{
    ...
    public EditText_custom(Context context, @Nullable AttributeSet attrs)
    {
        super(context, attrs);
        setFont(context,attrs);
    }

    public EditText_custom(Context context, @Nullable AttributeSet attrs, int defStyleAttr) {
